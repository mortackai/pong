...
class game:
    ...
    def run(self):
        ...
        while not done:
            ...
            if keyboard.is_pressed('UP') and player2_pos_y > 0:
                player2_pos_y -= 10
            if keyboard.is_pressed('DOWN') and player2_pos_y < self.height:
                player2_pos_y += 10
            ...
            if self.width - 20 < ball_pos_x < self.width - 10 and player2_pos_y < ball_pos_y < player2_pos_y + 100:
                ball_vel_x = -ball_vel_x
            # print(ball_pos_y)
